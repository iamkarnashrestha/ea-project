...
-- SET IDENTITY_INSERT member_table ON
    INSERT INTO member_table(id,email,firstName,lastName,password,role_id) values ('Abenezer@miu.edu','Abenezer','Dana','$2a$08$kOieqCi3cs2UtCdPUjhhRO3I9HI8XecWZxEG1TRgSAcTacA7JR86e')
